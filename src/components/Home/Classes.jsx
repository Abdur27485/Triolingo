    ...
    return (
        <div className='max-w-7xl mx-auto mt-32 px-4'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                <div className='grid grid-cols-1 lg:grid-cols-10 border border-black p-4 bg-base-200'>
                    <div className='lg:col-span-4 lg:mr-4 overflow-hidden rounded-md'>
                        <img src="https://img-b.udemycdn.com/course/240x135/851712_fc61_6.jpg" className='w-full lg:w-auto rounded-md hover:scale-105 transition duration-100' alt="" />
                    </div>
